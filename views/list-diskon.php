                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 text-end">
                                <a href="create-diskon.php" class="btn btn-success">
                                    <i class="fa-solid fa-plus"></i> Tambah Kartu Diskon
                                </a>
                            </div>
                                ...
                                <tbody>
                                    <?php foreach ($kartu_diskon as $index => $item) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit-diskon.php?id=<?= $item['id'] ?>" class="btn btn-warning">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="delete-diskon.php?id=<?= $item['id'] ?>" class="btn btn-danger">
