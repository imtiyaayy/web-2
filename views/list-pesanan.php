                                ...
                                <tbody>
                                    <?php foreach ($pesanan as $index => $pesanan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="detail-pesanan.php?id=<?= $pesanan['id'] ?>" class="btn btn-primary">
                                                    <i class="fas fa-eye"></i> Detail
                                                </a>
                                                <a href="edit-pesanan.php?id=<?= $pesanan['id'] ?>" class="btn btn-warning">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="delete-pesanan.php?id=<?= $pesanan['id'] ?>" class="btn btn-danger">
